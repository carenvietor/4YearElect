...
df4["Percentage highschool graduates"] = df4["highschool average"] / df7["2014 Population"]

# Most Highschool Grads
highschool = df4.nlargest(5, ['Percentage highschool graduates'])
print(highschool)
x = list(highschool["States"])
y = list(highschool["Percentage highschool graduates"])
...
highschools = df4.nsmallest(5, ['Percentage highschool graduates'])
print(highschools)
x = list(highschools["States"])
y = list(highschools["Percentage highschool graduates"])
plt.bar(x, y, color="red")
...
# bachelor degree
df5["Percentage Bachelor graduates"] = df5["bachelor average"] / df7["2014 Population"]

# most bachelor degrees
bachelor = df5.nlargest(5, ['Percentage Bachelor graduates'])
print(bachelor)
x = list(bachelor["States"])
y = list(bachelor["Percentage Bachelor graduates"])
plt.bar(x, y, color="green")
...
bachelors = df5.nsmallest(5, ['Percentage Bachelor graduates'])
print(bachelors)
x = list(bachelors["States"])
y = list(bachelors["Percentage Bachelor graduates"])
plt.bar(x, y, color="red")
...
# degree
df6["Percentage Graduates"] = df6["graduate average"] / df7["2014 Population"]

#most degrees
graduate = df6.nlargest(5, ['Percentage Graduates'])
print(graduate)
x = list(graduate["States"])
y = list(graduate["Percentage Graduates"])
plt.bar(x, y, color="green")
...
#most graduate average
graduate = df6.nlargest(5, ['graduate average'])
print(graduate)
x = list(graduate["States"])
y = list(graduate["graduate average"])
plt.bar(x, y, color="green")
plt.title('States with most graduates 2010 to 2018')
plt.xlabel('States')
plt.ylabel('Graduates between 24 and 35 years')
plt.grid(False)
plt.show()
...
# least degree
graduates = df6.nsmallest(5, ['Percentage Graduates'])
print(graduates)
x = list(graduates["States"])
y = list(graduates["Percentage Graduates"])
plt.bar(x, y, color="red")
...
#least graduates average
graduate = df6.nsmallest(5, ['graduate average'])
print(graduate)
x = list(graduate["States"])
y = list(graduate["graduate average"])
plt.bar(x, y, color="red")
...
width = 0.35
fig, ax = plt.subplots()
ax.bar(x_labels, democrat_2, width, label = 'Democrats')
ax.bar(x_labels, republican_2, width, label = 'Republican')
ax.set_ylabel('Frequency')
ax.set_title('Distribution of votes from 1976 to 2016')
plt.xticks(rotation=90)
ax.legend()
